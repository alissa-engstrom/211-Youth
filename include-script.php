...
add_action( 'wp_enqueue_scripts', 'diabetes_deregister', 200 );

function diabetes_deregister() {
   if ( is_page(9687) || is_page(10026) ) {

        wp_dequeue_style( 'style-custom' );
        wp_dequeue_style( 'meta-css' );
        wp_dequeue_style( 'page-dragging' );
        wp_dequeue_style( 'image-picker' );
        wp_dequeue_style( 'confirm-dialog' );
        ...
        wp_deregister_style( 'widgets-on-pages' );
        wp_deregister_style( 'duplicate-post' );
        wp_deregister_style( 'et-shortcodes-css' );
        wp_deregister_style( 'et-shortcodes-responsive-css' );
        wp_deregister_style( 'Google-Font' );
        //wp_dequeue_style( 'lightboxStyle' );
       ...
       // wp_deregister_script( 'jquery' );
        wp_deregister_script('cufon');
        wp_dequeue_script( 'image-picker' );
        wp_dequeue_script( 'page-dragging' );
        wp_dequeue_script( 'edit-box' );
        wp_dequeue_script( 'confirm-dialog' );
